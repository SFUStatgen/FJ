...
3. Once we have the chromosome 8 founder sequences for the 55 pedigrees we can start doing our simulations. The files for doing simulations under the alternative hypothesis are:
