...
2. Once we get the 55 pedigrees and the founder sequences we can start doing our simulations. The files for doing simulations under the alternative hypothesis are:
