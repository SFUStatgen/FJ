...
6. When the simulations under the null hypothesis finish on the cluster, copy the output files back to your PC and prepare the summaries for the manuscript by knitting the Rmarkdown file **simnullSummary.Rmd** 
