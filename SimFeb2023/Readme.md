...
3. Once we have the chromosome 8 founder sequences for the 55 pedigrees we can start running simulations to get the power and ranking results under the alternative hypothesis. The files for doing simulations under the alternative hypothesis are:
